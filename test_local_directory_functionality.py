...
def test_basic_functionality():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print("\n3. テスト用ブックマークを作成...")
        bookmarks = [
            Bookmark(title="existing file1", url="https://example.com/1", folder_path=[]),  # 重複
            Bookmark(title="new file", url="https://example.com/2", folder_path=[]),        # 新規
            Bookmark(title="nested file", url="https://example.com/3", folder_path=["folder1"]),  # 重複
            Bookmark(title="brand new", url="https://example.com/4", folder_path=["folder1"]),    # 新規
            Bookmark(title="Test<>File", url="https://example.com/5", folder_path=["folder3"]),   # サニタイズテスト
        ]
