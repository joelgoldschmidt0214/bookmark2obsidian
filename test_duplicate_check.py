...
def create_test_bookmarks():
    ...
    bookmarks = [
        ...
        Bookmark(title="Python Documentation", url="https://docs.python.org", folder_path=["folder1"]),  # 重複
        Bookmark(title="Stack Overflow", url="https://stackoverflow.com", folder_path=["folder2"]),  # 重複
        Bookmark(title="Fresh Content", url="https://fresh.com", folder_path=["folder1"]),  # 新規
    ]
...
def test_duplicate_detection():
    ...
    try:
        ...
        # 期待される重複
        expected_duplicates = ["Google", "GitHub", "folder1/Python_Documentation", "folder2/Stack_Overflow"]
