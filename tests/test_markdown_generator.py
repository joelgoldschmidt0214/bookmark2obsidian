...
class TestMarkdownGenerator:
    ...
    def test_yaml_frontmatter_creation(
        self, generator, sample_page_data, sample_bookmark
    ):
        """YAML front matter生成テスト"""
        yaml_frontmatter = generator._create_yaml_frontmatter(
            sample_page_data, sample_bookmark
        )
    ...
    def test_tag_cleaning_for_obsidian(self, generator):
        ...
        test_cases = [
            ...
            ("", ""),
            (
                "very-long-tag-name-that-exceeds-fifty-characters-limit",
                "very-long-tag-name-that-exceeds-fifty-characters-l",
            ),
        ]
        ...
        for input_tag, expected in test_cases:
            ...
            assert result == expected, (
                f"Input: '{input_tag}' -> Expected: '{expected}', Got: '{result}'"
            )
    ...
    def test_complete_markdown_generation(
        ...
        """完全なMarkdown生成テスト"""
        markdown = generator.generate_obsidian_markdown(
            sample_page_data, sample_bookmark
        )
    ...
    def test_path_component_sanitization(self, generator):
        ...
        assert result.startswith("very-long-filename"), (
    ...
    def test_empty_content_handling(self, generator, sample_bookmark):
        ...
        markdown = generator.generate_obsidian_markdown(
            empty_page_data, sample_bookmark
        )
    ...
    def test_special_characters_in_content(self, generator, sample_bookmark):
        ...
        markdown = generator.generate_obsidian_markdown(
            special_page_data, sample_bookmark
        )
