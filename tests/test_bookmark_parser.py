...
<DL><p>
    ...
    <DT><A HREF="https://www.google.com/search">Google Search</A>
        ...
        google_bookmark = next((b for b in bookmarks if b.title == "Google Search"), None)
...
<DL><p>
    ...
    def test_get_statistics(self):
        ...
        assert stats['unique_domains'] == 4  # reactjs.org, github.com, google.com, stackoverflow.com
...
<DL><p>
    ...
    try:
        ...
        for i, bookmark in enumerate(bookmarks):
            ...
            print(f"     フォルダ: {' > '.join(bookmark.folder_path) if bookmark.folder_path else 'ルート'}")
