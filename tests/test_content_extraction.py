...
class TestContentExtraction:
    ...
    def test_content_quality_validation_good(self, scraper):
        ...
        # 品質検証テスト
        assert (
            scraper._validate_content_quality(good_article, "https://example.com/good")
            == True
        )
    ...
    def test_content_quality_validation_bad(self, scraper):
        ...
        # 品質検証テスト
        assert (
            scraper._validate_content_quality(bad_article, "https://example.com/bad")
            == False
        )
    ...
    def test_full_extraction_pipeline(self, scraper):
        ...
        result = scraper.extract_article_content(
            test_html, "https://example.com/test-article"
        )
    ...
    def test_error_page_detection(self, scraper):
        ...
        assert (
            scraper._validate_content_quality(error_article, "https://example.com/404")
            == False
        )
